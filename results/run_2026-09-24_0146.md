...
```
You can change your meal plan tier once during the first ten days of the semester (admin_meal_plan_changes.txt). After that, it is locked.
```
...
```
Based on the provided documents, the CS 210 final exam is not curved (the midterms are curved, but the final is not). 
