...
```
You can change your meal plan tier once, within the first ten days of the semester. After that, it is locked. (Source: admin_meal_plan_changes.txt)
```
